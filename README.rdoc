...
Ruby library.  At this time, this isn't complete, the decoration code base is a
couple old ideas being replaced by one, currently incomplete, idea.  In short,
at this time, the library is bullshit.
